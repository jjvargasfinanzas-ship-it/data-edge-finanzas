      ...
      <form onSubmit={(e) => e.preventDefault()} className="animate-fade-up" key={step}>
                ...
                <div key={a.key} className="rounded-2xl border border-line bg-surface p-4">
                  <div className="grid gap-3 sm:grid-cols-[170px_1fr_170px_auto] sm:items-end">
                    ...
                    <Field label={a.type === "credit_card" ? "Deuda actual" : "Saldo actual"}>
                      <Input inputMode="numeric" value={a.balance} onChange={(e) => update(a.key, { balance: e.target.value })} placeholder="$ 0" />
                    </Field>
                    <button
                      type="button"
                  ...
                  {a.type === "credit_card" && (
                    <div className="mt-3 grid grid-cols-3 gap-3">
                      <Field label="Cupo">
                        <Input inputMode="numeric" value={a.limit} onChange={(e) => update(a.key, { limit: e.target.value })} />
                      </Field>
        ...
        {step === 2 && (
          <>
            ...
            <p className="mt-2 text-muted">Con esto proyectamos cuándo llega tu dinero. Puedes agregar más ingresos después.</p>
